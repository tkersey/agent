...
integer and boolean operations, optionals, bounded vectors, typed blocks,
branches, loops, exact authored failures, returns, and typed effect
suspension. It privately assigns numeric value IDs, block IDs, continuation
parameters, resume placeholders, and edge arguments.
