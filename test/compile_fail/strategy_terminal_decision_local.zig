...
const Definition = agent.define(.{
    .name = "terminal-runtime-strategy",
    .version = "2.0.0",
    .instructions = "Return.",
    .Goal = u32,
    .Action = Action,
...
const Implementation = struct {
    ...
    pub fn emitDecisionLocal(comptime _: type, comptime _: void, flow: anytype, goal: anytype, _: anytype, _: anytype) agent.Value(u32) {
        flow.returnValue(goal);
        return goal;
    }
};
const Strategy = agent.strategy.custom(.{
    .semantic_identity = "fixture.terminal-runtime-strategy.v1",
    .config = {},
