...
async function runScenario({
    ...
    assert.equal(manifest.boundaryPackageVersion, "1.5.0");
    assert.equal(manifest.worldPackageVersion, "3.1.3");
...
console.log(JSON.stringify({
    ...
    boundaryPackageVersion: "1.5.0",
    boundaryMachineAbi: 2,
    worldPackageVersion: "3.1.3",
